...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("color_hex", sa.String(7), nullable=False, server_default=sa.text("'#CD7F32'")),
        sa.Column("icon_emoji", sa.String(8), nullable=False, server_default=sa.text("'🥉'")),
    ...
    op.create_table(
        ...
        sa.Column("first_name", sa.String(128), nullable=False, server_default=sa.text("''")),
        sa.Column("last_name", sa.String(128), nullable=True),
        sa.Column("language_code", sa.String(8), nullable=False, server_default=sa.text("'ru'")),
    ...
    op.create_table(
        ...
        sa.Column("meta", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default=sa.text("'{}'")),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("delivery_type", sa.Enum("auto", "manual", "mixed", name="delivery_type_enum", create_type=False), nullable=False, server_default=sa.text("'manual'")),
        sa.Column("input_fields", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default=sa.text("'[]'")),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(128), nullable=False),
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column("type", sa.Enum("product", "category", "loyalty", "promo", "time_based", "manual", name="discount_type_enum", create_type=False), nullable=False),
        sa.Column("target_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("discount_value_type", sa.Enum("percent", "fixed", name="discount_value_type_enum", create_type=False), nullable=False, server_default=sa.text("'percent'")),
    ...
    op.create_table(
        ...
        sa.Column("input_data", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default=sa.text("'{}'")),
        sa.Column("added_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("status", sa.Enum("new","pending_payment","paid","processing","clarification","completed","cancelled","dispute", name="order_status_enum", create_type=False), nullable=False, server_default=sa.text("'new'")),
        sa.Column("subtotal", sa.Numeric(12, 2), nullable=False),
        sa.Column("discount_amount", sa.Numeric(12, 2), nullable=False, server_default="0"),
        sa.Column("total_amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("payment_method", sa.Enum("balance","card_yukassa","usdt","ton","manual", name="payment_method_enum", create_type=False), nullable=True),
        sa.Column("promo_code_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("paid_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("input_data", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default=sa.text("'{}'")),
        sa.Column("delivery_data", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default=sa.text("'{}'")),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), server_default=sa.text("gen_random_uuid()"), nullable=False),
        sa.Column("order_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("from_status", sa.Enum("new","pending_payment","paid","processing","clarification","completed","cancelled","dispute", name="order_status_enum", create_type=False), nullable=True),
        sa.Column("to_status", sa.Enum("new","pending_payment","paid","processing","clarification","completed","cancelled","dispute", name="order_status_enum", create_type=False), nullable=False),
        sa.Column("changed_by_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("changed_by_type", sa.String(16), nullable=False, server_default=sa.text("'system'")),
    ...
    op.create_table(
        ...
        sa.Column("order_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("method", sa.Enum("balance","card_yukassa","usdt","ton","manual", name="payment_method_enum", create_type=False), nullable=False),
        sa.Column("status", sa.Enum("pending","succeeded","failed","refunded","cancelled", name="payment_status_enum", create_type=False), nullable=False, server_default=sa.text("'pending'")),
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("currency", sa.String(8), nullable=False, server_default=sa.text("'RUB'")),
        sa.Column("external_id", sa.String(128), nullable=True),
        sa.Column("idempotency_key", sa.String(64), nullable=False),
        sa.Column("raw_response", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default=sa.text("'{}'")),
        sa.Column("paid_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("username", sa.String(64), nullable=True),
        sa.Column("first_name", sa.String(128), nullable=False, server_default=sa.text("''")),
        sa.Column("role", sa.Enum("owner","admin","manager","operator","content", name="admin_role_enum", create_type=False), nullable=False, server_default=sa.text("'operator'")),
        sa.Column("permissions", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("is_active", sa.Boolean(), nullable=False, server_default="true"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("open","in_progress","waiting_user","resolved","closed", name="ticket_status_enum", create_type=False), nullable=False, server_default=sa.text("'open'")),
    ...
    op.create_table(
        ...
        sa.Column("attachments", postgresql.ARRAY(sa.String()), nullable=False, server_default=sa.text("'{}'")),
