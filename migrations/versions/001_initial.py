...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("delivery_type", sa.Enum("auto", "manual", "mixed", name="delivery_type_enum"), nullable=False, server_default=sa.text("'manual'")),
    ...
    op.create_table(
        ...
        sa.Column("discount_value_type", sa.Enum("percent", "fixed", name="discount_value_type_enum"), nullable=False, server_default=sa.text("'percent'")),
    ...
    op.create_table(
        ...
        sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("status", sa.Enum("new","pending_payment","paid","processing","clarification","completed","cancelled","dispute", name="order_status_enum"), nullable=False, server_default=sa.text("'new'")),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending","succeeded","failed","refunded","cancelled", name="payment_status_enum"), nullable=False, server_default=sa.text("'pending'")),
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("currency", sa.String(8), nullable=False, server_default=sa.text("'RUB'")),
    ...
    op.create_table(
        ...
        sa.Column("username", sa.String(64), nullable=True),
        sa.Column("first_name", sa.String(128), nullable=False, server_default=sa.text("''")),
        sa.Column("role", sa.Enum("owner","admin","manager","operator","content", name="admin_role_enum"), nullable=False, server_default=sa.text("'operator'")),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("open","in_progress","waiting_user","resolved","closed", name="ticket_status_enum"), nullable=False, server_default=sa.text("'open'")),
